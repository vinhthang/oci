...
| [**ADR-0030**](adr/0030-revert-k3s-flannel-to-vxlan.md) | **Revert K3s Flannel Backend to VXLAN** | 🟢 Accepted | Network | Revert K3s Flannel backend from wireguard-native back to vxlan and close UDP port 51820 since oracle10 is removed. |
